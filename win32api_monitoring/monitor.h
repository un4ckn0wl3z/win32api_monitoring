...
int WINAPI ProxyLoadMessageBoxA(HWND hWnd, LPCSTR lpText, LPCSTR lpCaption, UINT uType)
{
    logger << L"[HOOK] Intercepted call to MessageBoxA:\n" << L"- Text: " << lpText << L" - Caption: " << lpCaption << std::endl;
